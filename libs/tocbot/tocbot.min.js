  ...
  function (e, t) {
    e.exports = function (e) {
        ...
        var l = o.appendChild(
          (function (n) {
            ...
            return (
              ...
              l.setAttribute(
                'class',
                e.linkClass + ' node-name--' + n.nodeName + ' ' + e.extraLinkClasses,
              ),
              o.appendChild(l),
              o
            );
      ...
      function i(t) {
        ...
        return (
          t && ((l += ' ' + e.collapsibleClass), (l += ' ' + e.isCollapsedClass)),
      ...
      return {
        ...
        render: function (e, t) {
          ...
          if (null !== o)
            return (
              o.firstChild && o.removeChild(o.firstChild), 0 === t.length ? o : o.appendChild(n)
            );
        },
              ...
              (function () {
                ...
                'auto' === e.fixedSidebarOffset &&
                  ...
                  t > e.fixedSidebarOffset
                    ...
                    : (n.className = n.className.split(' ' + e.positionFixedClass).join(''));
              })();
          var s,
            c = r;
            ...
            t.call(m, function (t) {
              ...
              (function t(n) {
                if (
                  ...
                  return (
                    (n.className = n.className.split(' ' + e.isCollapsedClass).join('')),
              ...
              function a(e) {
                (o = e - n),
                  ...
                  o < c
                    ...
                    : (window.scrollTo(0, l + s), 'function' == typeof r.callback && r.callback());
              }
